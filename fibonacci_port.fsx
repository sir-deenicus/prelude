...
let newheap = FibHeap.create ()

FibHeap.insert_data newheap "a" 5.
FibHeap.insert_data newheap "b" 2.

newheap

FibHeap.extract_min_data newheap

/////////////////
#time "on"
let speedcheck = FibHeap.create<int,int> ()

//3 secs
for i in 1..1000000 do FibHeap.insert_data speedcheck i i

//40 secs
for i in 1..1000000 do FibHeap.extract_min_data speedcheck |> ignore
...
//2 secs
for i in 1..1000000 do s.Add i

//4 secs
for i in 1..1000000 do let x = s.Min in s.Remove x 
